...
Function-level coverage and risk are required within the existing iOS and
watchOS test CI jobs. Run both suites with `-enableCodeCoverage YES` and separate
